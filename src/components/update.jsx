...
//         const userRef = ref(database, `user/${loginId}`);
...
//                 localStorage.setItem('loginId', loginId); // Save loginId to localStorage
//                 navigate('/buyCard'); 
...
//             {fetchedImageUrl && <img src={fetchedImageUrl} alt="User" style={{ marginTop: 10, width: '100%', maxWidth: '300px' }} />}
